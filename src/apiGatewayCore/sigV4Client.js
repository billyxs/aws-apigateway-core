...
sigV4ClientFactory.newClient = function (config) {
  ...
  function buildAuthorizationHeader (accessKey, credentialScope, headers, signature) {
    return AWS_SHA_256 + ' Credential=' + accessKey +
          '/' + credentialScope + ', SignedHeaders=' + buildCanonicalSignedHeaders(headers) + ', Signature=' + signature
  }
  ...
  awsSigV4Client.makeRequest = function (request) {
    ...
    var signingKey = calculateSigningKey(awsSigV4Client.secretKey,
